...
def retrieve_content(gcs_file_path:str , heading_number : str , heading_title : str):
    ...
    Returns : A list containing two strings which are the locations of json files
    """
    import os
    ...
    #     content_name_1 = f'{file_name}_{heading_number}'
    #     location_1 = save_json.save_json_to_gcs(json.dumps(section_data_by_number, indent=2),"gs://genai_ex_documents/retreived_content_files/",content_name_1,"big-depth-471018-r6")
    ...
    #     content_name_2 = f'{file_name}_{heading_title}'
    #     location_2 = save_json.save_json_to_gcs(json.dumps(section_data_by_number, indent=2),"gs://genai_ex_documents/retreived_content_files/",content_name_2,"big-depth-471018-r6")
    ...
    if section_data_by_number:
        print(json.dumps(section_data_by_number, indent=2))
        content_name_1 = f'{file_name}_{heading_number}'
        location_1 = save_json.save_json_to_gcs(
            json.dumps(section_data_by_number, indent=2),
            "gs://genai_ex_documents/retreived_content_files/",
            content_name_1,
            "big-depth-471018-r6"
        )
    else:
    ...
    if section_data_by_title:
        ...
        print(json.dumps(data, indent=2))
        content_name_2 = f'{file_name}_{heading_title}'
        location_2 = save_json.save_json_to_gcs(
